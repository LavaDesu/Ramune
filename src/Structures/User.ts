import {
    ...
    User$getUser as UserFullResponse
} from "../Responses";
...
export class User extends Base {
     ...
     */
    constructor(parent: Client, data: UserResponse) {
    ...
    /**
     * Whether this user class is fully populated (to populate, call {@link populate})
     *
     * @returns A boolean type guard which can mark all optional properties as present
     */
    public isPopulated(): this is UserExtended {
        return this.countryName !== undefined;
    }

    /**
     * If this user was created given UserCompact, this method will populate
     * itself with results similar to {@link Client.getUser}
     *
     * If this user was already populated, this method would simply do nothing.
     *
     ...
     */
    public async populate(mode?: Gamemode): Promise<this> {
        if (this.isPopulated())
            return this;
    ...
    private populateExtended(data: UserFullResponse): this is UserExtended {
